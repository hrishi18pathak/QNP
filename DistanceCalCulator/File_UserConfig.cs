...
{
    public class File_UserConfigData
    {
        // ----- Variables -----
    ...
    public class File_UserConfig
    {
        // ----- Variables -----

        private static String m_path = Path.Combine(Application.UserAppDataPath, "File_UserConfig.txt");
        private static File_UserConfigData m_configData = new File_UserConfigData();


        // ----- Public Properties -----

        public static File_UserConfigData Data
        {
        ...
        public static Boolean Load()
        {
            ...
            try
            {
                // Zeilen aus der Datei "Config.txt" lesen: ie read lines from "Config.txt".
                ...
                // Properties mit Werten belegen: ie Show properties with values:
        ...
        public static Boolean Save()
        {
            ...
            try
            {
                ...
                {
                    // Schreibschutz aufheben: ie Write
