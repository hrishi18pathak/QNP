...
namespace DistanceCalCulator
{
    public class File_Searcher
    {
        ...
        public delegate void ThreadEndedEventHandler(File_ThreadEndedEventArgs e);
        ...
        private static File_SearcherParams m_pars = null;
        ...
        private static void SearchThread()
        {
            ...
            if (ThreadEnded != null)
            {
                ThreadEnded(new File_ThreadEndedEventArgs(success, errorMsg));
            }
        }
